...
unittest {
    ...
    a = real.min_normal * real.epsilon;
    a /= 99;
...
unittest {
    ...
    test(ilogb(-0.0) == FP_ILOGB0);
    // denormal
    test(ilogb(0.125 * real.min_normal) == real.min_exp - 4);
...
unittest
{
    ...
    test(!isNormal(real.min_normal/4));
...
unittest
{
    ...
    test(isZero(-0.0));
    test(!isZero(2.5));
    test(!isZero(real.min_normal / 1000));
}
...
unittest {
    static if (real.mant_dig == 64) {
        ...
        // denormals and zero
        test( nextUp(-real.min_normal) == -real.min_normal*(1-real.epsilon) );
        test( nextUp(-real.min_normal*(1-real.epsilon) == -real.min_normal*(1-2*real.epsilon)) );
        test( isIdentical(-0.0L, nextUp(-real.min_normal*real.epsilon)) );
        test( nextUp(-0.0) == real.min_normal*real.epsilon );
        test( nextUp(0.0) == real.min_normal*real.epsilon );
        test( nextUp(real.min_normal*(1-real.epsilon)) == real.min_normal );
        test( nextUp(real.min_normal) == real.min_normal*(1+real.epsilon) );
        // positive numbers
    ...
    test( nextDoubleUp(-double.min_normal) == -double.min_normal*(1-double.epsilon) );
    test( nextDoubleUp(-double.min_normal*(1-double.epsilon) == -double.min_normal*(1-2*double.epsilon)) );
    test( isIdentical(-0.0, nextDoubleUp(-double.min_normal*double.epsilon)) );
    test( nextDoubleUp(0.0) == double.min_normal*double.epsilon );
    test( nextDoubleUp(-0.0) == double.min_normal*double.epsilon );
    test( nextDoubleUp(double.min_normal*(1-double.epsilon)) == double.min_normal );
    test( nextDoubleUp(double.min_normal) == double.min_normal*(1+double.epsilon) );
    // positive numbers
    ...
    test( nextFloatUp(-float.min_normal) == -float.min_normal*(1-float.epsilon) );
    test( nextFloatUp(1.0) == 1.0+float.epsilon );
    test( nextFloatUp(-0.0) == float.min_normal*float.epsilon);
...
unittest
{
   ...
   test(feqrel(real.min_normal/8,real.min_normal/17)==3);
...
unittest {
    ...
    test(ieeeMean(0.5*real.min_normal*(1-4*real.epsilon),0.5*real.min_normal)==0.5*real.min_normal*(1-2*real.epsilon));
}
