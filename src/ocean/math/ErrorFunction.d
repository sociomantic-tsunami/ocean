...
static immutable real SQRT2PI = 0x1.40d931ff62705966p+1L;    // 2.5066282746310005024
static immutable real EXP_2  = 0.13533528323661269189L; /* exp(-2) */
...
static immutable real [] P = [ -0x1.30dfa809b3cc6676p-17, 0x1.38637cd0913c0288p+18,
...
static immutable real [] Q = [ 0x1.14d8e2a72dec49f4p+19, 0x1.0c880ff467626e1p+23,
...
static immutable real [] R = [ 0x1.b9f6d8b78e22459ep-6, 0x1.1b84686b0a4ea43ap-1,
   0x1.b8f6aebe96000c2ap+1, 0x1.cb1dbedac27c8ec2p+2, 0x1.cf885f8f572a4c14p+1
];

static immutable real [] S = [
...
static immutable real [] T = [ 0x1.0da01654d757888cp+20, 0x1.2eb7497bc8b4f4acp+17,
   0x1.79078c19530f72a8p+15, 0x1.4eaf2126c0b2c23p+11, 0x1.1f2ea81c9d272a2ep+8,
   0x1.59ca6e2d866e625p+2, 0x1.c188e0b67435faf4p-4
];

static immutable real [] U = [ 0x1.dde6025c395ae34ep+19, 0x1.c4bc8b6235df35aap+18,
...
unittest {
   // High resolution test points.
    static immutable real erfc0_250 = 0.723663330078125 + 1.0279753638067014931732235184287934646022E-5;
    static immutable real erfc0_375 = 0.5958709716796875 + 1.2118885490201676174914080878232469565953E-5;
    static immutable real erfc0_500 = 0.4794921875 + 7.9346869534623172533461080354712635484242E-6;
    static immutable real erfc0_625 = 0.3767547607421875 + 4.3570693945275513594941232097252997287766E-6;
    static immutable real erfc0_750 = 0.2888336181640625 + 1.0748182422368401062165408589222625794046E-5;
    static immutable real erfc0_875 = 0.215911865234375 + 1.3073705765341685464282101150637224028267E-5;
    static immutable real erfc1_000 = 0.15728759765625 + 1.1609394035130658779364917390740703933002E-5;
    static immutable real erfc1_125 = 0.111602783203125 + 8.9850951672359304215530728365232161564636E-6;

    static immutable real erf0_875  = (1-0.215911865234375) - 1.3073705765341685464282101150637224028267E-5;
...
real expx2(real x, int sign)
{
    ...
    */
    static immutable real M = 32768.0;
    static immutable real MINV = 3.0517578125e-5L;
...
body
{
static immutable real[] P0 = [ -0x1.758f4d969484bfdcp-7, 0x1.53cee17a59259dd2p-3,
...
static immutable real[] Q0 = [ -0x1.64b92ae791e64bb2p-7, 0x1.7585c7d597298286p-3,
...
static immutable real[] P1 = [ 0x1.20ceea49ea142f12p-13, 0x1.cbe8a7267aea80bp-7,
...
static immutable real[] Q1 = [ 0x1.3a4ce1406cea98fap-13, 0x1.f45332623335cda2p-7,
...
static immutable real[] P2 = [ 0x1.8c124a850116a6d8p-21, 0x1.534abda3c2fb90bap-13,
...
static immutable real[] Q2 = [ 0x1.af03f4fc0655e006p-21, 0x1.713192048d11fb2p-13,
...
static immutable real[] P3 = [ -0x1.55da447ae3806168p-34, -0x1.145635641f8778a6p-24,
...
static immutable real[] Q3 = [ -0x1.74022dd5523e6f84p-34, -0x1.2cb60d61e29ee836p-24,
