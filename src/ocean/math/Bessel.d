...
// Peak error =  1.80e-20
static immutable real[] j0modulusn = [ 0x1.154700ea96e79656p-7, 0x1.72244b6e998cd6fp-4,
...
static immutable real[] j0modulusd = [ 0x1.5b84007c37011506p-7, 0x1.cfe76758639bdab4p-4,
...
static immutable real[] j0phasen = [ -0x1.ccbaf3865bb0985ep-22, -0x1.3a6b175e64bdb82ep-14,
   -0x1.06124b5310cdca28p-8, -0x1.3cebb7ab09cf1b14p-4, -0x1.00156ed209b43c6p-1,
   -0x1.78aa9ba4254ca20cp-1
];

static immutable real[] j0phased = [ 0x1.ccbaf3865bb09918p-19, 0x1.3b5b0e12900d58b8p-11,
...
// Peak error =  2e-21
static immutable real[] j1n = [ -0x1.2f494fa4e623b1bp+58, 0x1.8289f0a5f1e1a784p+52,
...
static immutable real[] j1d = [ 0x1.5a1e0a45eb67bacep+75, 0x1.35ee485d62f0ccbap+68,
...
static immutable real [] j1modulusn = [ 0x1.059262020bf7520ap-6, 0x1.012ffc4d1f5cdbc8p-3,
...
static immutable real [] j1modulusd = [ 0x1.47d4e6ad98d8246ep-6, 0x1.42562f48058ff904p-3,
...
static immutable real [] j1phasen = [ 0x1.ca9f612d83aaa818p-20, 0x1.2e82fcfb7d0fee9ep-12,
   0x1.e28858c1e947506p-7, 0x1.12b8f96e5173d20ep-2, 0x1.965e6a013154c0ap+0,
   0x1.0156a25eaa0dd78p+1
];

static immutable real [] j1phased = [ 0x1.31bf961e57c71ae4p-18, 0x1.9464d8f2abf750a6p-11,
...
static immutable real[] j0n = [ -0x1.3e8ff72b890d72d8p+59, 0x1.cc86e3755a4c803p+53,
...
static immutable real[] j0d = [ 0x1.0096dec5f6560158p+73, 0x1.11705db14995fb9cp+66,
   ...
   1.0
    ...
    xx = x * x;
    if ( xx < 81.0L ) {
        static immutable real [] JZ = [5.783185962946784521176L,
...
static immutable real[] y0n = [ -0x1.068026b402e2bf7ap+54, 0x1.3a2f7be8c4c8a03ep+55,
...
static immutable real[] y0d = [ 0x1.bc96c5351e564834p+57, 0x1.6821ac3b4c5209a6p+51,
...
static immutable real[] y059n = [ -0x1.0fce17d26a21f218p+19, -0x1.c6fc144765fdfaa8p+16,
 ...
 */
    ...
    xx = x * x;
    if ( xx < 81.0L ) {
        static immutable real [] JZ = [1.46819706421238932572e1L,
    ...
    static immutable real M_3PI_4 = 3 * PI_4;
...
static immutable real [] y1n = [ -0x1.32cab2601090742p+54, 0x1.432ceb7a8eaeff16p+52,
...
static immutable real [] y1d = [ 0x1.8733bcfd7236e604p+56, 0x1.5af412c672fd18d4p+50,
...
static immutable real[] y159n = [ 0x1.2fed87b1e60aa736p+18, -0x1.1a2b18cdb2d1ec5ep+20,
...
static immutable real[] y159d = [ 0x1.9b64f2a4d5614462p+26, -0x1.17501e0e38db675ap+30,
...
double cylBessel_i0(double x)
{
    ...
    static immutable double [] A = [    0x1.5a84e9035a22ap-1,  -0x1.37febc057cd8dp-2,
    ...
    static immutable double [] B = [      0x1.9be62aca809cbp-1,   0x1.b998ca2e59049p-9,
...
{
    static immutable double [] A = [       0x1.02a63724a7ffap-2,  -0x1.694d10469192ep-3,
    ...
    static immutable double [] B = [       0x1.8ea18b55b1514p-1,  -0x1.3fda053fcdb4cp-7,
...
static immutable real [4][] j0_test_points = [
...
static immutable real [4][] y0_test_points = [
...
static immutable real [4][] j1_test_points = [
...
static immutable real [4][] y1_test_points = [
